...
def generate_prd_v2(new_feature, new_feature_desc, wandb_name):
    ...
    # with open(f"./generated_prds/{new_feature}_prd_v2.md", "w") as f: # For deployment
    # # with open(f"../generated_prds/{new_feature}_prd_v2.md", "w") as f: # For local testing
    #     f.write(output)
